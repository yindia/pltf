...
resource "google_service_account" "gke_node" {
  account_id   = "pltf-${var.layer_name}-${random_string.node_pool_hash.result}"
  display_name = "pltf-${var.layer_name}-default-node-pool"
...
resource "google_container_node_pool" "node_pool" {
  name               = "pltf-${var.layer_name}-${random_string.node_pool_id.id}"
  ...
  node_config {
    ...
    tags         = ["pltf-${var.layer_name}-nodes"]
    ...
    labels = {
      node_pool_name = "pltf-${var.layer_name}-secondary"
    }
