resource "aws_security_group" "eks" {
  name_prefix = "pltf-${var.layer_name}"
  description = "EKS cluster security group."
  vpc_id      = var.vpc_id

  tags = {
    "Name" = "pltf-${var.layer_name}-eks_cluster_sg"
  }
...
resource "aws_eks_cluster" "cluster" {
  ...
  # To be fixed, although early pltf users need this - Cluster allows access from a public CIDR: 0.0.0.0/0
...
resource "aws_cloudwatch_log_group" "cluster_logs" {
  name              = "/aws/eks/pltf-${var.layer_name}/cluster"
