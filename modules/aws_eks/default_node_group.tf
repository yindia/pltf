...
resource "aws_iam_role" "node_group" {
  name = "pltf-${var.layer_name}-eks-default-node-group"
...
resource "aws_eks_node_group" "node_group" {
  ...
  node_group_name = "pltf-${var.layer_name}-default-${random_id.key_suffix.hex}"
  ...
  labels         = { node_group_name = "pltf-${var.layer_name}-default" }
